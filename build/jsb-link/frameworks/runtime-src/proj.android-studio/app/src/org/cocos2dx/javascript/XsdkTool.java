...
public class XsdkTool {
	...
	public static String getUTF8String(final String oristr) throws UnsupportedEncodingException {
		return new String(oristr.getBytes("utf-8"), "UTF-8");
	}
